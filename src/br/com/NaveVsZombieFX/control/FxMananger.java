...
public class FxMananger {
    ...
    public static String NOME_PROGRAMA = "Nave vs zombie";
    public static boolean ONLINE;
    public static final String VIEW = "/br.com.NaveVsZombieFX.control/".replace("control", "view").replace(".", "/");

    static {
        image = new Image(FxMananger.class.getResourceAsStream(VIEW + "image/icone.png"));
    }
    ...
    public static Parent loadFXML(String arquivo) throws IOException {
        return FXMLLoader.load(FxMananger.class.getResource(VIEW + arquivo + ".fxml"));
    }
